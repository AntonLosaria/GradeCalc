...
int classStandForMidterm() {
    ...
    cout << "Processing the entered activities for midterm..." << endl;
...
int classStandForFinals()
{
	...
	cout << "Processing the entered activities for finals..." << endl;
...
int main() {
    ...
    cout << "Enter 1 for Calculate Prelim" << endl << "Enter 2 to Calculate Midterm" << endl << "Enter 3 to Calculate Finals";
    cin >> choice;
    ...
    switch (choice) {
		...
		case 3:
			...
			if (midtermEncoded == false)
			{
				cout << "Midterm grade is not encoded yet. Would you like to encode it? 1 if Yes, 0 if No";
				cin >> c;
				if (c == 1)
				{
					classStandForMidterm();
